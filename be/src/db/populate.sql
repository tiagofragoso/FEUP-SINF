...
insert into warehouses(id, x, y) values("A00", 2, 0);
insert into warehouses(id, x, y) values("A01", -1, 0);
insert into warehouses(id, x, y) values("A02", 3, 3);
insert into warehouses(id, x, y) values("A03", 4, 5);
insert into warehouses(id, x, y) values("A04", 7, 6);